...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $lawtonEisenhowerOneSingles['school_id'] = 504;
        ...
        $lawtonEisenhowerTwoSingles['school_id'] = 504;
        ...
        $lawtonEisenhowerOneDoublesPlayerOne['school_id'] = 504;
        ...
        $lawtonEisenhowerOneDoublesPlayerTwo['school_id'] = 504;
        ...
        $lawtonEisenhowerTwoDoublesPlayerOne['school_id'] = 504;
        ...
        $lawtonEisenhowerTwoDoublesPlayerTwo['school_id'] = 504;
        ...
        $user->school_id = 71;
        $user->password = '$2y$10$FLs7m7zx1EjnIBTuurXah.SJaB7tI38BU/652QyR1mN5IpFSO8q82';
        $user->saveOrFail();
        ...
        $mooreOneDoublesPlayerOne['school_id'] = 71;
        ...
        $mooreOneDoublesPlayerTwo['school_id'] = 71;
        ...
        $mooreTwoDoublesPlayerOne['school_id'] = 71;
        ...
        $mooreTwoDoublesPlayerTwo['school_id'] = 71;
        ...
        $schoolIDs = [504, 317, 340, 71, 81, 82, 99, 298];
